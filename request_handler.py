...
class HandleRequests(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        # function next.
        if resource == "animals":
            resourceFound = create_animal(post_body)
        # Encode the new animal and send in response
        
        if resource == "locations":
            resourceFound = create_location(post_body)
        
        if resource == "employees":
            resourceFound = create_employee(post_body)
        
        if resource == "customers":
            resourceFound = create_customer(post_body)
    ...
    def do_PUT(self):
        ...
        # Replace a single animal from the list
        if resource == "animals":
